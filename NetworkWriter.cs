...
namespace UnityEngine.Networking
{
  ...
  {
    private static UIntFloat s_FloatConverter = new UIntFloat();
    ...
    /// 
    /// </summary>
    /// <param name="buffer">Array of bytes to write.</param><param name="count">Number of bytes from the array to write.</param>
    ...
    /// 
    /// <para>
    /// This writes the a reference to a GameObject with a NetworkIdentity component to the stream. The object should have been spawned for clients to know about it.
    /// </para>
    /// 
    /// </summary>
