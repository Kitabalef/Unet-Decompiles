...
namespace UnityEngine.Networking.Match
{
  ...
  /// 
  /// <para>
  /// A component for communicating with the UNET Matchmaking service.
  /// </para>
  /// 
  /// </summary>
  public class NetworkMatch : MonoBehaviour
  {
    ...
    /// 
    /// <para>
    /// The base URI of the UNET MatchMaker that this NetworkMatch will communicate with.
    /// </para>
    /// 
    /// </summary>
    public Uri baseUri
    ...
    public NetworkMatch()
    {
      ...
      if (!ulong.TryParse(PlayerPrefs.GetString("CloudNetworkingId"), out result))
        ...
        this.SetProgramAppID((AppID) result);
    }
