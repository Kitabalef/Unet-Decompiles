...
namespace UnityEngine.Networking
{
  ...
  public class NetworkReader
  {
    ...
    public ulong ReadPackedUInt64()
    {
      ...
      byte num3 = this.ReadByte();
      if ((int) num1 == 249)
        return (ulong) (2287L + 256L * (long) num2) + (ulong) num3;
      byte num4 = this.ReadByte();
      if ((int) num1 == 250)
    ...
    {
      return this.ReadBytes((int) this.ReadUInt16());
    }
    ...
    public Transform ReadTransform()
    {
      ...
      if ((UnityEngine.Object) localObject == (UnityEngine.Object) null && LogFilter.logDebug)
    ...
    public GameObject ReadGameObject()
    {
      ...
      if ((UnityEngine.Object) localObject == (UnityEngine.Object) null && LogFilter.logDebug)
      {
        ...
        int index1 = 0;
        string str1 = "ReadGameObject netId:";
        ...
        int index4 = 3;
        GameObject gameObject = localObject;
    ...
    public NetworkIdentity ReadNetworkIdentity()
    {
      ...
      if ((UnityEngine.Object) localObject == (UnityEngine.Object) null && LogFilter.logDebug)
      {
        object[] objArray = new object[4];
        int index1 = 0;
        string str1 = "ReadNetworkIdentity netId:";
        objArray[index1] = (object) str1;
        int index2 = 1;
        // ISSUE: variable of a boxed type
        __Boxed<NetworkInstanceId> local = (ValueType) netId;
      ...
      return localObject.GetComponent<NetworkIdentity>();
    }
